...
CREATE TABLE IF NOT EXISTS `cardealer_vehicles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `vehicle` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `properties` (
  ...
  `label` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `entering` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `exit` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `inside` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `outside` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ipls` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT '[]',
  `gateway` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_single` int(11) DEFAULT NULL,
  `is_room` int(11) DEFAULT NULL,
  `is_gateway` int(11) DEFAULT NULL,
  `room_menu` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `price` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `name` (`name`)
...
CREATE TABLE IF NOT EXISTS `rented_vehicles` (
  ...
  `plate` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL,
  `player_name` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `position` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT '{"x":-269.4,"y":-955.3,"z":31.2,"heading":205.8}',
  ...
  `last_property` varchar(190) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `weashops` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `zone` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `item` varchar(190) COLLATE utf8mb4_unicode_ci NOT NULL,
  `price` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
